...
<div class="app-sidebar-menu">
                            ...
                            <div id="sidebar-menu">
                                <div class="logo-box">
                                    ...
                                    <div class="logo-circle">
                                        <img src="{{ asset('assets/images/admin-icon.png') }}" alt="Admin"
                                            class="admin-icon">
                                    </div>
                                </div>
    ...
    <a class="tp-link active" href="{{ route('product.index') }}">
        ...
        <span>Quản Lý Sản Phẩm</span>
                                    ...
                                    <!-- Quản Lý Đơn Hàng -->
                                    <li class="menuitem-active">
                                        <a class="tp-link active" href="{{ route('admin.ordermanagement') }}">
                                            <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor"
                                                stroke-width="2" fill="none" stroke-linecap="round"
                                                stroke-linejoin="round" class="css-i6dzq1">
                                    ...
                                    <!-- Quản Lý Bình Luận -->
                                    <li class="menuitem-active">
                                        <a class="tp-link active" href="{{ route('admin.commentmanagement') }}">
                                            <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor"
                                                stroke-width="2" fill="none" stroke-linecap="round"
                                                stroke-linejoin="round" class="css-i6dzq1">
                                                <path
                                    ...
                                    <!-- Quản Lý Liên Hệ -->
                                    <li class="menuitem-active">
                                        <a class="tp-link active" href="{{ route('admin.contacts.index') }}">
                                    ...
                                    <li class="menuitem-active">
                                        <form action="{{ route('admin.logout') }}" method="POST"
                                            ...
                                            @csrf
                                            <button type="submit" class="tp-link"
